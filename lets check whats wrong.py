...
accelerometer_data = "sensor_data/Raw Data 1.csv"
...
kinematic_data = np.vstack((time, acceleration_x, acceleration_y, acceleration_z, updated_velocity_x, updated_velocity_y, updated_velocity_z, position_x, position_y, position_z))

GraphingModule.graph(kinematic_data)